	...
	<p>&nbsp;</p>
		<form method="post" action="usercadastro.php" class="cool s12">
			...
			<div class="input-field col s12">
				...
				<input type="text" name="matricula" value="<?php echo $matricula; ?>" maxlength="9">
			 ...
			 <div class="input-field col s12">
				...
				<input type="text" name="cpf" value="<?php echo $cpf; ?>" maxlength="11">
				<label>CPF</label>				
			</div>
			...
			<div class="input-field col s12">
				...
				<input type="text" name="rg" value="<?php echo $rg; ?>" maxlength="40">
